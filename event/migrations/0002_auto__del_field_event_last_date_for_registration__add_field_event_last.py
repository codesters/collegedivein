...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Event.last_date_for_registration'
        db.delete_column('event_event', 'last_date_for_registration')

        # Adding field 'Event.last_date'
        db.add_column('event_event', 'last_date',
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Event.last_date_for_registration'
        db.add_column('event_event', 'last_date_for_registration',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Event.last_date'
        db.delete_column('event_event', 'last_date')


        # Changing field 'Event.slug'
        db.alter_column('event_event', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))
